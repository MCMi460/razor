...
class AudioPlayer():
    ...
    def is_playing(self) -> bool:
        return self.music and bool(mix.Mix_PlayingMusic())

    def is_paused(self) -> bool:
        return self.music and bool(mix.Mix_PausedMusic())

    def get_state(self) -> AudioState:
        return AudioState.Paused if self.is_paused() else AudioState.Playing if self.is_playing() else AudioState.Stopped
